...
void Logger::log(LogLevel level, const QString &message, const QString &category)
{
    ...
    QString formattedMessage = formatMessage(level, message, category, timestamp);
...
QString Logger::formatMessage(LogLevel level, const QString &message, const QString &category, const QDateTime &timestamp)
{
