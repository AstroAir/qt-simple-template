...
void ApplicationModel::clearStatus()
{
...
void ApplicationModel::resetModel()
{
    initializeDefaults();
}

bool ApplicationModel::beforePropertySet(const QString &propertyName, const QVariant &value)
{
...
void ApplicationModel::afterPropertySet(const QString &propertyName, const QVariant &oldValue, const QVariant &newValue)
{
    Q_UNUSED(oldValue)
...
void ApplicationModel::initializeDefaults()
{
    ...
    setPropertySilent(PROPERTY_APP_VERSION, QCoreApplication::applicationVersion());
