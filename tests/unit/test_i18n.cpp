...
{
    qDebug("Starting I18n tests");
}

void TestI18n::cleanupTestCase()
{
    qDebug("Finished I18n tests");
}
...
void TestI18n::testTranslationFilesExist()
{
    ...
    QVERIFY2(englishTs.exists(), "English translation source file should exist");
    
    QFile chineseTs(i18nDir + "/app_zh.ts");
    QVERIFY2(chineseTs.exists(), "Chinese translation source file should exist");
}
