...
def main():
    parser = argparse.ArgumentParser(description="Run tests for qt-simple-template")
    ...
    parser.add_argument("--parallel", "-j", type=int, default=1, help="Number of parallel jobs")
